...
export default class extends Controller {
    ...
    // Child controllers can override this to prepare/transform data
    prepareData(rawData) {
        return rawData;
    }

    // Child controllers should override this to render the chart with chart ready data
    ...
    handleResize(chart) {
        ...
        if (
            ...
            updated_settings.legendPosition
        ) {
            chart.options.plugins.legend.position =
                updated_settings.legendPosition;
            chart.options.plugins.legend.title.text =
                updated_settings.legendTitle;
            chart.update();
        }
    }
